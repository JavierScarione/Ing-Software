...
"""
    ...
    Este programa permite recuperar una clave desde un archivo JSON con el objetivo de realizar 
    pedidos bancarios. 
    Utilizando el patrón Singleton, cadenas de comando e iteradores.
"""
